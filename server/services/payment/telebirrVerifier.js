...
exports.TelebirrVerifier = void 0;
...
class TelebirrVerifier {
    ...
    async verify(transactionId) {
        try {
            ...
            if (!this.apiKey) {
                logger_1.default.error('VERIFIER_API_KEY not configured');
                return {
                    isValid: false,
            ...
            logger_1.default.error('Telebirr verification error:', error);
            return {
                isValid: false,
    ...
    async verifyWithAPI(transactionId) {
        try {
            ...
            if (!response.ok) {
                ...
                logger_1.default.error(`Telebirr API error: ${response.status} - ${errorText}`);
            ...
            if (data && data.error) {
                logger_1.default.warn(`Telebirr verification failed: ${data.error}`);
            }
            return null;
        }
        catch (error) {
            logger_1.default.error('Telebirr API request failed:', error);
            throw error;
        }
    }
    ...
    validateReceiverMatch(receiver) {
...
exports.TelebirrVerifier = TelebirrVerifier;
exports.default = TelebirrVerifier;
//# sourceMappingURL=telebirrVerifier.js.map