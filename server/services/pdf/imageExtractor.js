...
exports.pdfImageExtractor = exports.PDFImageExtractor = void 0;
...
class PDFImageExtractor {
    ...
    async extractImages(buffer) {
        try {
            ...
            logger_1.logger.error('Failed to extract images from PDF:', error);
            return {
                photo: null,
                qrCode: null,
                barcode: null
     ...
     */
    async findEmbeddedImages(buffer) {
        const result = {
            photo: null,
            qrCode: null,
            barcode: null
        ...
        try {
            ...
            logger_1.logger.error('Error finding embedded images:', error);
        }
        return result;
    }
    /**
     ...
     */
    async extractBarcodeData(_imageBuffer) {
        // Placeholder - would use a library like zxing-js or quagga
        logger_1.logger.warn('Barcode extraction not implemented');
        return null;
    }
    /**
     ...
     */
    async extractQRCodeData(_imageBuffer) {
        // Placeholder - would use a library like jsqr or qrcode-reader
        logger_1.logger.warn('QR code extraction not implemented');
        return null;
    }
}
exports.PDFImageExtractor = PDFImageExtractor;
// Export singleton instance
exports.pdfImageExtractor = new PDFImageExtractor();
exports.default = exports.pdfImageExtractor;
