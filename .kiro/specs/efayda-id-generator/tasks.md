...
- [x] 7. Payment Service Implementation
  ...
  - [x] 7.4 Write property test for valid transaction credits wallet
    - **Property 11: Valid Transaction Credits Wallet**
    - **Validates: Requirements 6.3, 7.3**

  - [x] 7.5 Write property test for invalid/used transaction rejection
    - **Property 12: Invalid/Used Transaction Rejection**
    - **Validates: Requirements 6.4, 7.4**

  - [x] 7.6 Write property test for wallet balance invariant
    - **Property 13: Wallet Balance Invariant**
    - **Validates: Requirements 8.1, 8.4, 8.6**

  - [x] 7.7 Write property test for insufficient balance prevention
    - **Property 14: Insufficient Balance Prevention**
    - **Validates: Requirements 8.5**

  - [x] 7.8 Write property test for transaction ID uniqueness
    - **Property 19: Transaction ID Uniqueness**
    - **Validates: Requirements 6.4, 7.4**

- [x] 8. Checkpoint - Payment Service
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. ID Generation Service Implementation
  - [x] 9.1 Implement image processor utilities
  ...
  - [x] 9.2 Write property test for image mirroring round-trip
    - **Property 4: Image Mirroring Round-Trip**
    - **Validates: Requirements 3.4**

  - [x] 9.3 Write property test for grayscale idempotence
    - **Property 5: Grayscale Conversion Idempotence**
    - **Validates: Requirements 3.6**

  - [x] 9.4 Implement card renderer for front card
  ...
  - [x] 9.5 Implement card renderer for back card
  ...
  - [x] 9.6 Implement card variant generator
  ...
  - [x] 9.7 Write property test for image resolution compliance
    - **Property 6: Image Resolution Compliance**
    - **Validates: Requirements 3.10**

  - [x] 9.8 Implement A4 PDF generator
  ...
  - [x] 9.9 Write property test for A4 PDF page size
    - **Property 7: A4 PDF Page Size**
    - **Validates: Requirements 4.1**

- [x] 10. Checkpoint - ID Generation Service
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Job Queue Implementation
  - [x] 11.1 Set up Bull queue with Redis
    - Configure job queue with retry settings
    - Set up job processors
    - Implement job status tracking
    - _Requirements: 11.1, 11.2_

  - [x] 11.2 Implement job processor
  ...
  - [x] 11.3 Write property test for job retry limit
    - **Property 16: Job Retry Limit**
    - **Validates: Requirements 11.3**

  - [x] 11.4 Implement job failure handling
    - Notify user on permanent failure
    - Refund wallet on failure
    - Log failure details
    - _Requirements: 11.4, 13.3_

  - [x] 11.5 Write property test for failed job refund
    - **Property 17: Failed Job Refund**
    - **Validates: Requirements 11.4**

- [x] 12. File Delivery and Cleanup
  - [x] 12.1 Implement file delivery service
    - Generate descriptive filenames
    - Send files as Telegram documents
    - Track delivery status
    - _Requirements: 5.1, 5.2, 5.3, 5.4_

  - [x] 12.2 Write property test for output file count
    - **Property 8: Output File Count**
    - **Validates: Requirements 5.1, 5.2**

  - [x] 12.3 Write property test for file delivery filename format
    - **Property 9: File Delivery Filename Format**
    - **Validates: Requirements 5.4**

  - [x] 12.4 Implement temporary file cleanup
  ...
  - [x] 12.5 Write property test for temporary file cleanup
    - **Property 10: Temporary File Cleanup**
    - **Validates: Requirements 5.5, 12.2**

- [x] 13. Checkpoint - Job Queue and Delivery
  - Ensure all tests pass, ask the user if questions arise.

- [x] 14. Security and Rate Limiting
...
- [x] 15. Telegram Bot Handlers
  ...
  - [x] 15.7 Write property test for top-up amount options
    - **Property 20: Top-up Amount Options**
    - **Validates: Requirements 8.3**

  - [x] 15.8 Implement /pricing command handler
    - Display service pricing
    - Show package details
    - _Requirements: 9.6_

  - [x] 15.9 Implement /settings command handler
    - Display settings menu
    - Handle settings updates
    - _Requirements: 9.7_

  - [x] 15.10 Implement /help command handler
    - Display help information
    - Show usage guide
    - Provide support contact
    - _Requirements: 9.8, 13.5_

  - [x] 15.11 Implement inline keyboard handlers
    - Create reusable keyboard builders
    - Handle callback queries
    - Provide progress feedback
    - _Requirements: 9.9, 9.10_

- [x] 16. Checkpoint - Bot Handlers
  - Ensure all tests pass, ask the user if questions arise.

- [x] 17. Integration and Error Handling
  ...
  - [x] 17.3 Implement graceful shutdown
...
- [x] 19. Deployment Configuration
  - [x] 19.1 Create production Docker configuration
