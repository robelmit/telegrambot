...
async function generateHgigatCard() {
  try {
    console.log('=== Generating Hgigat Aregawi Hagos ID Card ===\n');
    ...
    console.log('FIN:', data.fin, data.fin ? '✓' : '✗ NOT EXTRACTED');
    ...
    // Save combined image
    const outputPath = 'test-output/hgigat-combined.png';
    ...
    const outputPdfPath = 'test-output/hgigat-combined.pdf';
    ...
    console.log('\n=== GENERATION COMPLETE ===');
    console.log('\nFiles created:');
    console.log('- test-output/hgigat-combined.png (card image)');
    console.log('- test-output/hgigat-combined.pdf (printable PDF)');
